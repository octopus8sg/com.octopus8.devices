    ...
    <div class="crm-accordion-wrapper crm-expenses_search-accordion">
      ...
      <div class="crm-accordion-body">
        <table class="form-layout alertrule-filter">
          <tbody>
          <tr>
            <td class="label">{$form.alert_rule_id.label}</td>
            <td>{$form.alert_rule_id.html}</td>
            <td class="label">{$form.alert_rule_contact_id.label}</td>
            <td>{$form.alert_rule_contact_id.html}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="label">{$form.alert_rule_type.label}</td>
            <td>{$form.alert_rule_type.html}</td>
          </tr>
          </tbody>
        </table>
