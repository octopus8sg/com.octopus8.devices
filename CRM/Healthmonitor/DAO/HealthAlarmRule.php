 ...
 * (GenCodeChecksum:6cfc4603d57eac8f94caf820af7da511)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'sensor_id' => [
          ...
          'required' => TRUE,
          'import' => TRUE,
          'where' => 'civicrm_health_alarm_rule.sensor_id',
          'export' => TRUE,
          'default' => '1',
          'table_name' => 'civicrm_health_alarm_rule',
          'entity' => 'HealthAlarmRule',
...
//          'type' => CRM_Utils_Type::T_MONEY,
        ...
        'rule_id' => [
          ...
          'pseudoconstant' => [
            'optionGroupName' => 'health_alarm_rule_type',
            'optionEditPath' => 'civicrm/admin/options/health_alarm_rule_type',
          ],
          'add' => NULL,
        ],
      ];
