 ...
 * (GenCodeChecksum:ac6fc8a74b605fff36983c0e4609ce5c)
 */
...
class CRM_Healthmonitor_DAO_HealthAlarm extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'health_alarm_rule_id', 'civicrm_health_alarm_rule', 'id');
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'health_alarm_rule_id' => [
          'name' => 'health_alarm_rule_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => E::ts('FK to Health Alarm Rule'),
          'where' => 'civicrm_health_alarm.health_alarm_rule_id',
          'table_name' => 'civicrm_health_alarm',
          'entity' => 'HealthAlarm',
          'bao' => 'CRM_Healthmonitor_DAO_HealthAlarm',
          'localizable' => 0,
        ...
        'addressee_id' => [
          ...
          'where' => 'civicrm_health_alarm.addressee_id',
          'table_name' => 'civicrm_health_alarm',
          'entity' => 'HealthAlarm',
          'bao' => 'CRM_Healthmonitor_DAO_HealthAlarm',
          'localizable' => 0,
