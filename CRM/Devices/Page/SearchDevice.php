...
class CRM_Devices_Page_SearchDevice extends CRM_Core_Page
{
    public function run()
    {
        // Example: Set the page-title dynamically; alternatively, declare a static title in xml/Menu/*.xml
        CRM_Utils_System::setTitle(E::ts('Search Devices'));

        // link for datatables
        $urlQry['snippet'] = 4;
        $devices_source_url = CRM_Utils_System::url('civicrm/devices/device_ajax', $urlQry, FALSE, NULL, FALSE);
//        $devices_source_url = "";
        $sourceUrl['devices_source_url'] = $devices_source_url;
