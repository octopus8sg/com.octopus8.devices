...
class CRM_Devices_Form_Report_ContactDeviceDetail extends CRM_Report_Form
{
...
//            CRM_Core_Error::debug_var('table', $table);
    ...
    public function from()
    {
        ...
        $civicrm_device = $this->_aliases['civicrm_o8_device_device'];
      ...
      FROM civicrm_contact {$this->_aliases['civicrm_contact']} {$this->_aclFrom}
        ...
        INNER JOIN civicrm_o8_device_device {$civicrm_device}
...
//                    // handle contribution
//
                    if ($component == 'o8_device_device_civireport') {

                        if ($val = CRM_Utils_Array::value('civicrm_o8_device_device_device_type_id', $row)) {
//                            CRM_Core_Error::debug_var('val', $val);
                            $componentRows[$contactID][$component][$rowNum]['civicrm_o8_device_device_device_type_id']
                                = CRM_Core_PseudoConstant::getLabel("CRM_Devices_BAO_Device", "device_type_id", $val);
                        }
                    }
