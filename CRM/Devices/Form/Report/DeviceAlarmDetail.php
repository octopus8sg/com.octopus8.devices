...
class CRM_Devices_Form_Report_DeviceAlarmDetail extends CRM_Report_Form
{
...
//      $this->_groupByArray = [$this->_aliases['civicrm_o8_device_data_soft'] . '.id'];
//    }
//    else {
...
//                            CRM_Core_Error::debug_var('val', $val);
            ...
            if ($val = CRM_Utils_Array::value('civicrm_o8_device_data_sensor_value', $row)) {

                $rows[$rowNum]['civicrm_o8_device_data_sensor_value']
                    = strval(floatval($val));
            }
