 ...
 *
 * Generated from com.octopus8.devices/xml/schema/CRM/Devices/04_Alarm.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:d6129377d1d9636116bfd076b11721db)
 */
use CRM_Devices_ExtensionUtil as E;

/**
 * Database access object for the Alarm entity.
 */
class CRM_Devices_DAO_Alarm extends CRM_Core_DAO {
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('Alarms') : E::ts('Alarm');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'device_data_id' => [
          ...
          'bao' => 'CRM_Devices_DAO_Alarm',
          'localizable' => 0,
          'FKClassName' => 'CRM_Devices_DAO_DeviceData',
          'add' => NULL,
        ],
        'alarm_rule_id' => [
          'name' => 'alarm_rule_id',
