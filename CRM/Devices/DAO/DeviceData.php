 ...
 * (GenCodeChecksum:82eed3259b5b80e2dfa216b1ad805fb5)
 */
...
class CRM_Devices_DAO_DeviceData extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'device_id', 'civicrm_o8_device_', 'id');
