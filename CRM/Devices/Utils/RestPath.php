 ...
 */
class CRM_Devices_Utils_RestPath {
  ...
  public function get() {
    ...
    if ($currentCMS == CRM_Devices_Utils_CmsUser::CMS_JOOMLA ) {
  ...
  public function isWpRestPluginActive() {
    if (CRM_Devices_Utils_CmsUser::getInstance()->getSystem() !== CRM_Devices_Utils_CmsUser::CMS_WORDPRESS ) {
      return false;
    }
