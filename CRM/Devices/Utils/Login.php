...
class CRM_Devices_Utils_Login {
    ...
    /**
     * CMS Id which related to email and password
     *
     * @var int
     */
    public $cmsContactId;
    ...
    /**
     * CiviCrm contact assign cms contact
     *
    ...
    public function __construct($request) {
        ...
        $this->cmsContactId = $request->cmsContactId;
    ...
    private function invokePreResponseHook() {
        CRM_Utils_Hook::singleton()
            ->commonInvoke(1, $this->cmsContactId, $this->nullObject, $this->nullObject, $this->nullObject, $this->nullObject, $this->nullObject, 'civimobile_auth_pre', '');
    }
